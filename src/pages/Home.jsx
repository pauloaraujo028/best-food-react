...
import imgHome from "../assets/images/drip.svg";
...
const Home = () => {
  ...
  return (
    <div>
      <div className="w-full mx-auto py-4 h-[300px] bg-black">
      ...
      <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
        ...
        <div className="rounded-xl relative">
          ...
          <img
            ...
            src="https://images.unsplash.com/photo-1551024601-bec78aea704b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTQ0fHxmb29kfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            alt="/"
          />
        </div>
        {/* Card */}
        <div className="rounded-xl relative">
          ...
          <img
            className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl"
            src="https://images.unsplash.com/photo-1563778084459-859099e48677?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjcyfHxmb29kfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            alt="/"
          />
        </div>
        {/* Card */}
        <div className="rounded-xl relative">
          ...
          <img
            className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl"
            src="https://images.unsplash.com/photo-1506459225024-1428097a7e18?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTc0fHxmb29kfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            alt="/"
          />
        </div>
      </div>
      ...
      <div className="max-w-[1640px] m-auto px-4 py-12">
        <h1 className="text-orange-600 font-bold text-4xl text-center">
          Itens do menu mais bem Avaliados
        </h1>
        {/* Categories */}
